                        ...
                        DispatchQueue.main.async {
                            withAnimation(injector.animation(TimeInterval(duration))){
                                ...
                                if bool{
                                    ...
                                    default:
                                        fatalError("Orientation \(pri.orientation) is not aviliable is this mode! Please refer to the documentations.")
                                    }
                                    ...
                                    default:
                                        fatalError("Orientation \(sec.orientation) is not aviliable is this mode! Please refer to the documentations.")
                                    }
                                    injector.scale = 1 - (scaleMargin ?? 0)
                                }
